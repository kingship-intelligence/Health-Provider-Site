      ...
      <section className="relative pt-24 pb-32 overflow-hidden bg-muted">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl">
            ...
            >
              Let's Create Your Path{" "}
              <span className="text-primary italic">To Wellness</span>.
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              At Restoration LLC, we provide personalized psychiatric care that
              helps you restore balance and find your path to mental wellness.
            ...
            >
              ...
              <Link href="/locations">
                <Button
                  size="lg"
                  variant="outline"
                  className="text-base h-14 px-8 rounded-full bg-background/50 backdrop-blur"
                >
                  Visit Our Clinic
                </Button>
              </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              We offer comprehensive services designed to keep you healthy, not
              just treat you when you're sick.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            <div className="max-w-2xl">
              ...
              <p className="text-muted-foreground text-lg">
                Experienced, compassionate providers who take the time to
                listen.
              </p>
            </div>
                    ...
                    <div className="aspect-[3/4] overflow-hidden bg-muted relative">
                      ...
                      {provider.acceptingNewPatients && (
                        <div className="absolute top-3 right-3">
                          <Badge className="bg-primary text-primary-foreground hover:bg-primary shadow-sm border-none">
                            Accepting Patients
                          </Badge>
                        </div>
                      )}
