    ...
    <div className="flex flex-col min-h-screen">
      <div className="bg-muted/30 pt-16 pb-12 border-b">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mb-8">Meet Dr. Olayemi Olajuyigbe and Dr. Bolanle Olajuyigbe.</p>
          <div className="flex flex-col sm:flex-row gap-4 max-w-2xl bg-card p-4 rounded-2xl shadow-sm border">
            ...
            {(specialtyFilter || locationFilter) && (
              <Button variant="ghost" onClick={() => { setSpecialtyFilter(""); setLocationFilter(""); }} className="shrink-0 text-muted-foreground hover:text-foreground">
                Clear
              </Button>
            )}
          </div>
